...
import { getAllInsc, newInsciption, editInsciption, getInscxUser, getInscxCurso, deleteInsc, getxMonths } from '../../controllers/inscripciones.controller.js'
...
routesInscripciones.get('/api/v1/inscription/date/:year', verifyToken, AdminInstPermissions, getxMonths)
