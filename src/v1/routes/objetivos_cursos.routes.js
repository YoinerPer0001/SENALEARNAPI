...
/**
 * @swagger
 * /api/v1/obj_cursos/{id}:
 *   get:
 *     tags:
 *      - Objetivos de cursos
 *     summary: Retorna la lista de objetivos de un curso.
 *     parameters:
 *       - name: id
 *         in: path
 *         required: true
 ...
 *                 data: [{
                            "Id_Objetivo": "1",
                            "Desc_Objetivo": "ejemplo de objetivo",
                            "Id_Cur_FK": "1"
                        }]
 *       '204':
...
/**
 * @swagger
 * /api/v1/obj_cursos/create:
 *   post:
 *     security:
 *       - bearerAuth: []
 *     tags:
 *       - Objetivos de cursos
 *     summary: Crear una nuevo objetivo (Solo para roles de Admin e Instructor).
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     tags:
 *       - Objetivos de cursos
 *     summary: Actualizar Objetivos de cursos (Solo para roles de Admin e Instructor).
 *     parameters:
 *       - name: id
 *         in: path
 *         required: true
 *         description:  id de objetivo del curso.
 *         schema:
 *           type: string
 *           minLenght: 1
 *     requestBody:
 ...
 *               data: {"affectedRows": 1}
 *       '204':
 *         description: La operación se realizó correctamente, pero no hubo datos que devolver (No retorna informacion)
 *         content:
 *           application/json:
 *             schema:
 *               type: array
