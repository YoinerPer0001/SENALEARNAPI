...
export const createValidation = [
    ...
    check('Hor_Cont_Total')
        .exists().withMessage('Hor_Cont_Total is required')
        .not().isEmpty().withMessage('Hor_Cont_Total cannot be empty')
        .isNumeric().withMessage('Hor_Cont_Total must be a number')
        .isLength({ max: 100 }).withMessage('max length is 100'),
    check('Fech_Crea_Cur')
        .exists().withMessage('Fech_Crea_Cur is required')
        .not().isEmpty().withMessage('Fech_Crea_Cur cannot be empty')
