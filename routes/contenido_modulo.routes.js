 ...
 *               message: algo salió mal
 */
contModRoutes.post('/api/cont_mod/create', verifyToken, createContModu)
/**
 * @swagger
 * /api/cont_mod/update/{id}:
 *   put:
 *     security:
 *       - bearerAuth: []
 *     tags:
...
contModRoutes.put('/api/cont_mod/update/:id', verifyToken, UpdateModCur);
