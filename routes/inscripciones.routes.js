 ...
 *                 message: algo salio mal
 */
routesInscripciones.get('/api/inscripciones', verifyToken, getAllInsc)
/**
 * @swagger
 * /api/inscripciones/user/{id}:
 *   get:
 *     security:
 *       - bearerAuth: []
 *     tags:
 ...
 *                 message: algo salio mal
 */
routesInscripciones.get('/api/inscripciones/user/:id', verifyToken, getInscxUser)
/**
 * @swagger
 * /api/inscripciones/course/{id}:
 *   get:
 *     security:
 *       - bearerAuth: []
 *     tags:
 ...
 *                 message: algo salio mal
 */
routesInscripciones.get('/api/inscripciones/course/:id', verifyToken, getInscxCurso)
/**
 * @swagger
 ...
 *               message: algo salió mal
 */
routesInscripciones.post('/api/inscripciones/create', verifyToken, newInsciption)
/**
 * @swagger
 ...
 *               message: algo salió mal
 */
routesInscripciones.put('/api/inscripciones/update/:id', verifyToken, editInsciption)

routesInscripciones.delete('/api/inscripciones/delete/:id_User/:id_Curso', verifyToken, deleteInsciption)
